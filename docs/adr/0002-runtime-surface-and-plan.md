...
| M7.5 | Operational readiness before any listener: backup/restore and rollover under the single-writable-lineage rule, limits and alerts, crash and load tests, policies, the TestPyPI rehearsal; designed in [docs/spec/operations.md](../spec/operations.md) |
