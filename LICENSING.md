...
together with its tests; that file is the controlling text. The package metadata declares
the runtime's license explicitly (`license = "BUSL-1.1"` in `pyproject.toml`), not only
